...
# creating a .png plot file for all 4 charts in one window
...
plot(my_data$Voltage, type="l",xaxt = "n", xlab="datetime", ylab="Voltage") #"datetime" xlabel looks ugly yet here it is as required
axis(side=1, at=c(1, 1442, 2881), labels=c("Thu","Fri","Sat"))
